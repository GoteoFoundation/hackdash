...
// Addons: numeric ID
user_schema.plugin(autoIncrement.plugin, { model: 'User', field: 'userId', startAt: 1, incrementBy: 1 });
// methods ======================
// generating a hash
...
// Addons: numeric ID
project_schema.plugin(autoIncrement.plugin, { model: 'Project', field: 'projectId', startAt: 1, incrementBy: 1 });
