  ...
  Project.find(q)
    ...
    .exec(function(err, projects) {
      ...
      _.each(projects, function(p, i){
        ...
        _.each(resps && resps.responses || [], function(r, i){
          // Skip duplicates
          // if(_.find(responses, function(q) {
          //     return q.question._id == r.question.toString();
          //   })) {
          //   return;
          // }
          r.question = _.find(form.questions, function(q){
            return q._id == r.question.toString();
          });
          if(r.question) {
            responses.push(r);
          }
