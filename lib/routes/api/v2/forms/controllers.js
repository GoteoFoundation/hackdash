...
export const saveResponse = (req, res, next) => {
  ...
  try {
    ...
    model.forms.forms = model.forms.forms || [];
    ...
    console.log('RESULT', 'public', req.form.public, 'form', pform.form, 'responses', pform.responses, 'model.forms', model.forms.toString());
    model.forms.push(pform);
