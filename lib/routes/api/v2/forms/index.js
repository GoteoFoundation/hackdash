...
import {getForm,getForms,sendForms,updateForm,sendForm,canEditForm,canViewForm,createForm,saveResponse,sendResponse,uploadFile,sendFile,deleteFile,getTemplates,deleteForm,getResponses,sendResponses} from './controllers';
...
app.get('/forms/:fid/responses', cors(), isAuth, getResponses, sendResponses);
