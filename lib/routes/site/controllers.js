...
import {port, host, publicHost, title, publicDashboardCreation, homeCreateProject, defaultHomeTab, disqus_shortname, discourseUrl, googleAnalytics, facebookAppId, useLocalLogin, googleApiKey, theme, language, languages, skills, internalComments, commentTypes, maxQueryLimit, minProjects, allowedOrigins} from 'config/config.json';
...
export const viewsStack = [
  ...
  setViewVar('allowedOrigins', allowedOrigins || ""),
