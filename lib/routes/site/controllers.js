...
import {port, host, publicHost, title, publicDashboardCreation, homeCreateProject, homeToolsUrl, live, disqus_shortname, discourseUrl, googleAnalytics, facebookAppId, useLocalLogin, googleApiKey} from 'config/config.json';
