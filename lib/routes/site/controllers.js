...
import {port, host, publicHost, publicDashboardCreation, homeCreateProject, homeToolsUrl, live, disqus_shortname, googleAnalytics, facebookAppId, useLocalLogin} from 'config';
...
const appHost = `${publicHost ? publicHost : host}`;
