...
import {port, host, publicHost, title, publicDashboardCreation, homeCreateProject, defaultHomeTab, live, disqus_shortname, discourseUrl, googleAnalytics, facebookAppId, useLocalLogin, googleApiKey, theme, language} from 'config/config.json';
