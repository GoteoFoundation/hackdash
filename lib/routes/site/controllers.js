...
import {port, host, publicHost, publicDashboardCreation, homeCreateProject, homeToolsUrl, live, disqus_shortname, googleAnalytics, facebookAppId, useLocalLogin, googleApiKey} from 'config/config.json';
