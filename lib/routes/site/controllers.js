...
import {port, host, publicHost, title, publicDashboardCreation, homeCreateProject, defaultHomeTab, live, disqus_shortname, discourseUrl, googleAnalytics, facebookAppId, useLocalLogin, googleApiKey, theme, language, languages, skills, internalComments, commentTypes, maxQueryLimit} from 'config/config.json';
