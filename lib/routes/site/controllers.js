...
import {port, host, publicHost, title, publicDashboardCreation, homeCreateProject, defaultHomeTab, live, disqus_shortname, discourseUrl, googleAnalytics, facebookAppId, useLocalLogin, googleApiKey, theme, language, skills, internalComments, commentTypes, maxQueryLimit} from 'config/config.json';
...
export const viewsStack = [
  ...
  setViewVar('language', JSON.stringify(language)),
