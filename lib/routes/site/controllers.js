...
import {port, host, publicHost, title, publicDashboardCreation, homeCreateProject, homeToolsUrl, live, disqus_shortname, discourseUrl, googleAnalytics, facebookAppId, useLocalLogin, googleApiKey, theme, language} from 'config/config.json';
...
export const viewsStack = [
  ...
  setViewVar('homeToolsUrl', homeToolsUrl),
